...
export default function CourseCard({ course, onAddToTrip, tripId }: CourseCardProps) {
      ...
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
        <button
          ...
          style={{
            ...
            background:    added ? 'var(--cream-dark)' : 'var(--gold)',
            color:         added ? 'var(--text-light)' : 'var(--green-deep)',
            fontSize:      '11px',
            fontWeight:    600,
